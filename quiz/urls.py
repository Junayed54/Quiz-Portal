...
from .views import ExamViewSet, ExamDetailView, LeaderboardListView, QuestionViewSet, QuestionOptionViewSet, UserCreatedExamsView, ExamUploadView, CategoryViewSet #SubmitAnswerView, CalculateResultsView
...
urlpatterns = [
    ...
    path('create_exam/', TemplateView.as_view(template_name='create_exam.html'), name='create_exam'),
    path('user_exams/', TemplateView.as_view(template_name='user_exams.html'), name='user_exams'),
